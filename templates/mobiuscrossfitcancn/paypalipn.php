...
//    mail("info@mobiuscrossfitcancun.com", "prueba ippn", $e->getMessage());
...
if ($verified) {
    ...
    if ($_POST['receiver_email'] != 'info@mobiuscrossfitcancun.com') {
    ...
    if (!empty($errmsg)) {
        ...
        mail('info@mobiuscrossfitcancun.com', 'IPN Fraud Warning', $body);
        ...
        $subject = "Mobiuscrossfitcancun.com - Pago de inscripción";
        mail($to,$subject,"Gracias por realizar tu pago de inscripción - Por favor, presenta tu voucher de pago impreso a muestra sucursal.");
    
    }
    
} else {
    // manually investigate the invalid IPN
    mail('info@mobiuscrossfitcancun.com', 'Invalid IPN', $listener->getTextReport());
}
