...
//$subject = 'Nuevo contacto desde Möbius Makeover';
...
//$message .="Teléfono: ".$numero."\n";
//$message .="Imágen: ".$varname."\n";
//$message .="Imágen: ".$vartemp."\n";
//$message .="Soy un buen candidato por que: ".$comments."\n";
...
$sAsunto= "Registro nuevo desde Mobiuscrossfitcancun.com/MAKEOVER";
...
//$to="info@mobiuscrossfitcancun.com";

if (form_mail("info@mobiuscrossfitcancun.com,jhonny@punkmkt.com,marijo@punkmkt.com", $_POST[asunto],
"Nuevo contacto desde Möbius Makeover:\n\n", $_POST[email]))

        echo '<script>
            alert("Tu registro ha sido procesado satisfactoriamente.");
             document.location=("http://mobiuscrossfitcancun.com/");
            </script>';
