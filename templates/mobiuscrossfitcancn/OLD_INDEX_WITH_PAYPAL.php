...
<!--    <meta property="og:title" content="Mobius CrossFit Cancún"/>
    <meta property="og:type" content="article"/>
    <meta property="og:url" content="http://mobiuscrossfitcancun.com/"/>
    <meta property="og:image" content="http://mobiuscrossfitcancun.com/templates/mobiuscrossfitcancn/images/webcuts/logo.png"/>
    <meta property="og:site_name" content="Mobius CrossFit Cancún"/>-->
  ...
  <link rel="stylesheet" href="<?php echo $tpath; ?>/css/reset.css">
  <link rel="stylesheet" href="<?php echo $tpath; ?>/css/style.css">
  <link rel="stylesheet" href="<?php echo $tpath; ?>/css/coaches.css">
  <link rel="stylesheet" href="<?php echo $tpath; ?>/css/horarios.css">
  <link rel="stylesheet" href="<?php echo $tpath; ?>/css/galeria.css">
  <link rel="stylesheet" href="<?php echo $tpath; ?>/css/ubicacion.css">
  <link rel="stylesheet" href="<?php echo $tpath; ?>/css/wod.css">
  <link rel="stylesheet" href="<?php echo $tpath; ?>/css/blog.css">
  <link rel="stylesheet" href="<?php echo $tpath; ?>/css/makeover.css">
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=431077440298512";
  ...
  <header id="header">
      ...
      <div class="mobius_top">

          <div id="logo">

            <a href="http://mobiuscrossfitcancun.com/"><img src="http://mobiuscrossfitcancun.com/templates/mobiuscrossfitcancn/images/webcuts/logo.png" title="Mobius CrossFit Cancún" alt="Mobius CrossFit Cancún"></a>

          </div>

          <div class="mobius-info">
              <div>
              ...
              <div class="redes_sociales">
                  <ul>
                      <li class="twitterme"><a href="https://twitter.com/MobiusCrossfit" target="_blank"><img src="http://mobiuscrossfitcancun.com/templates/mobiuscrossfitcancn/images/webcuts/twitter-icon.png" title="Mobius CrossFit Cancún" alt="Mobius CrossFit Cancún"></a></li>
                      <li class="facebook"><a href="https://www.facebook.com/MobiusCrossfit" target="_blank"><img src="http://mobiuscrossfitcancun.com/templates/mobiuscrossfitcancn/images/webcuts/facebook-icon.png" title="Mobius CrossFit Cancún" alt="Mobius CrossFit Cancún"></a></li>
                      <li id="mailme"><img src="http://mobiuscrossfitcancun.com/templates/mobiuscrossfitcancn/images/webcuts/mail-icon.png" title="Mobius CrossFit Cancún" alt="Mobius CrossFit Cancún"></li>
                      <li class="mapa"><a href="/ubicacion/"><img src="http://mobiuscrossfitcancun.com/templates/mobiuscrossfitcancn/images/webcuts/pin.png" title="Encuéntranos" alt="Encuéntranos"></a></li>
                  </ul>
              </div>
          </div>
      ...
      <div id="menu_principal">
          ...
          <?php if ($this->countModules('menu_principal')): ?>
            ...
            <div class="conmenu">
                ...
                <jdoc:include type="modules" name="menu_principal" style="none" />
  ...
  <!--CONTENIDO DEL SITIO-->
          ...
          <?php if ($this->countModules('main_slide')): ?>
          ...
          <?php if ($this->countModules('crossfit-info')): ?>

                <div class="crossfit-info">

                    <jdoc:include type="modules" name="crossfit-info" style="none" />
          ...
          <?php if ($this->countModules('eventos')): ?>

            <div class="eventos">

                <jdoc:include type="modules" name="eventos" style="none" />
          ...
          <?php if ($this->countModules('contenidos')): ?>
            ...
            <div class="category-content">
                ...
                <?php if ($this->countModules('articulos')): ?>

                  <div class="articulos">

                      <jdoc:include type="modules" name="articulos" style="none" />
                ...
                <?php if ($this->countModules('right_content')): ?>

                  <div class="right_content">

                      

                      <?php if ($this->countModules('right_content_items_paypal')): ?>
                      ...
                      <div class="paypal">
                          ...
                          <div id="descnpersonas">
                              <span>1 Persona: 990 MXN</span>
                          </div>
                            <div class="items_paypal">
                                ...
                                <?php
                                     ...
                                     $email="info@mobiuscrossfitcancun.com";
//                                     $email = 'german-facilitator@punkmkt.com';

                                ?>

                                <form name="_xclick" target="_blank" action="https://<?php echo $PAYPAL_HOST; ?>/cgi-bin/webscr" 
                                    ...
                                    <input type="hidden" name="item_name" value="Pago de Inscripción - Mobius CrossFit Cancún">

                                    <input id="amount" type="hidden" name="amount" value="990">

                                    <input type="hidden" name="return" value="http://mobiuscrossfitcancun.com/mobius/">

                                    <!--<input type="hidden" name="notify_url" value="http://mobiuscrossfitcancun.com/mobius/templates/mobiuscrossfitcancn/paypalipn.php">-->
                                ...
                                <jdoc:include type="modules" name="right_content_items_paypal" style="mystyle" />
                      ...
                      <?php if ($this->countModules('right_content_items')): ?>

                        <div class="items">

                            <jdoc:include type="modules" name="right_content_items" style="mystyle" />
                      ...
                      <?php if ($this->countModules('right_content_item_form')): ?>
                        ...
                        <div class="items">
                            ...
                            <jdoc:include type="modules" name="right_content_item_form" style="none" />
                      ...
                      <?php if ($this->countModules('right_content_items2')): ?>

                        <div class="item2">

                            <jdoc:include type="modules" name="right_content_items2" style="none" />
                      ...
                      <jdoc:include type="modules" name="right_content" style="none" />
                ...
                <jdoc:include type="modules" name="contenidos" style="none" />
            ...
            <div id="contenidos">
                ...
                <div class="top">
                    ...
                    <?php if ($this->countModules('footer_right')): ?>
                      ...
                      <div class="contenidos_footer_right">
...
<!--  <jdoc:include type="modules" name="debug" />-->
    ...
    <script type="text/javascript" src="<?php echo $tpath; ?>/js/jquery.js"></script>
    ...
    <script src="<?php echo $tpath; ?>/js/modal.js"></script-->
    <script src="<?php echo $tpath; ?>/js/jquery-ui-1.10.3.custom.js"></script>
    <script type="text/javascript" src="<?php echo $tpath; ?>/js/fancybox.js"></script>
    <script type="text/javascript" src="<?php echo $tpath; ?>/js/validate.js"></script>

    <script type="text/javascript" src="<?php echo $tpath; ?>/js/cycle.js"></script>

    <script type="text/javascript" src="<?php echo $tpath; ?>/js/main.js"></script>
    <script type="text/javascript">
    $(document).ready(function(){
        
        $('#menu_principal .conmenu ul.menu').removeClass("nav");
        ...
        $('#npersonas').change(function(){
        html='';
        precio='';
        personas=$(this).val();
          switch(personas){
            case '1':
              html+='<span>'+personas+' Persona: 990 MXN</span>';
              precio=990;
            break;
            case '2':
              html+='<span>'+personas+' Personas: 1800 MXN</span>';
              precio=1800;
            break;
            case '5':
                html+='<span>'+personas+' Personas: 4125 MXN</span>';
                precio=4125;
            break;
            default:
                html+='<span>'+personas+' Persona: 990 MXN</span>';
          ...
          $('#descnpersonas').html(html);
          $('#amount').attr('value',precio);
