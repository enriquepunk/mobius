...
define('DB_NAME', 'financit_blog');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'financit_fin');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'financit1984');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY', ''); // Cambia esto por tu frase aleatoria.
define('SECURE_AUTH_KEY', ''); // Cambia esto por tu frase aleatoria.
define('LOGGED_IN_KEY', ''); // Cambia esto por tu frase aleatoria.
define('NONCE_KEY', ''); // Cambia esto por tu frase aleatoria.
define('AUTH_SALT', ''); // Cambia esto por tu frase aleatoria.
define('SECURE_AUTH_SALT', ''); // Cambia esto por tu frase aleatoria.
define('LOGGED_IN_SALT', ''); // Cambia esto por tu frase aleatoria.
define('NONCE_SALT', ''); // Cambia esto por tu frase aleatoria.
/**#@-*/
