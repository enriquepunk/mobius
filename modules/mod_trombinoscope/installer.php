...
/**
 * Script file of the Trombinoscope module
 */
class mod_trombinoscopeInstallerScript
{	
	static $minimum_needed_library_version = '1.0';
	...
	{		
		...
		$files = array(
			'/modules/mod_trombinoscope/fields/contacts.php'
		);
