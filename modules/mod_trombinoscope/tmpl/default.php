	...
	?>
      ...
      <div class="item-makeover row-fluid">
          ...
          <div class="datos span8">
              <div class="items_mo">
                  <p><?php echo $item->field1?></p>
              </div>
              <div class="items_mo">
                  <p>Nombre: <span class="neg"><?php echo  $item->field2?></span></p>
              </div>
              <div class="items_mo">
                  <p>Edad: <span class="neg"><?php echo $item->field3?></span></p>
              </div>
              <div class="items_mo">
                  <p>Peso: <span class="neg"><?php echo $item->field4?></span></p>
              </div>
              <div class="items_mo">
                  <p>Historia: <span class="neg"><?php echo $item->field5?></span></p>
              </div>
              <div class="items_mo">
                  <p class="neg"><?php echo $item->address_format?></p><br>
              </div>
              <div class="items_mo">
                  <p class="neg">Arrancamos oficialmente con Möbius Makeover.
                        Durante 4 meses ayudaremos a <?php echo  $item->field2?> a alcanzar sus metas de fitness. Acompáñenlo en este viaje de transformación. Vamos equipo ¡FUERZA!</p>
              </div>
          </div>
        </div>
