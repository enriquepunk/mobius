...
.trombinoscope_<?php echo $suffix; ?>.personlist {
    padding-top:15px;
}

	.trombinoscope_<?php echo $suffix; ?> .person {
		overflow: hidden; 
		margin: 0 0 10px 0;
		border-bottom: 1px solid #CCCCCC;
	}
	
	.trombinoscope_<?php echo $suffix; ?> .person:last-child { /*                            <= style specific to the last card */
		margin: 0;
		border-bottom: none;
	}
	
		.trombinoscope_<?php echo $suffix; ?> .innerperson {
			overflow: hidden; 
			margin: 0 0 10px 0;
			padding: 2px;
		}
		
		.trombinoscope_<?php echo $suffix; ?> .even { /*                                     <= styles for even cards */
			border-bottom: none; /* to override k2 style */
			background: none; /* to override k2 style */
			padding: 0; /* to override k2 style */
		}
	
		.trombinoscope_<?php echo $suffix; ?> .odd { /*                                      <= styles for odd cards */
			border-bottom: none; /* to override k2 style */
			background: none; /* to override k2 style */
			padding: 0; /* to override k2 style */
		}
	
			.trombinoscope_<?php echo $suffix; ?> .personpicture { /*                        <= the contact's picture */
			...
			.trombinoscope_<?php echo $suffix; ?> .personpicture img {
				max-height: 120px; /*                                                        <= height for the image (or max height) */
				/*                                                                           <= width for the image (or max width) */
			}
			
			.trombinoscope_<?php echo $suffix; ?> .nopicture {
			...
			.trombinoscope_<?php echo $suffix; ?> .personinfo { /*                           <= the contact's info */
				padding: 5px 8px 5px 8px;
				/* max-width: 45%; may be necessary for long sentences */
			}
			
			.trombinoscope_<?php echo $suffix; ?> .left {
				clear: right;
				text-align: left; /*                                                         <= text left justified */
				margin-left: 108px; /*                                                       <= margin = picture size + padding + border */
			}
			
			.trombinoscope_<?php echo $suffix; ?> .right {
				clear: left;
				text-align: right; /*                                                        <= text right justified */
				margin-right: 108px; /*                                                      <= margin = picture size + padding + border */
			}
			
				.trombinoscope_<?php echo $suffix; ?> .personname { /*                       <= field name ... */
					font-size: 1em;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personfield1 {
					overflow: hidden; /* so it does not bleed over the picture */
				}				
				
				.trombinoscope_<?php echo $suffix; ?> .personfield2 {
					overflow: hidden;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personfield3 {
					overflow: hidden;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personfield4 {
					overflow: hidden;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personfield5 {
					overflow: hidden;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personfield1 span {
					font-size: 0.9em;
				}				
				
				.trombinoscope_<?php echo $suffix; ?> .personfield2 span {
					font-size: 0.9em;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personfield3 span {
					font-size: 0.9em;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personfield4 span {
					font-size: 0.9em;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personfield5 span {
					font-size: 0.9em;
				}
				
					.trombinoscope_<?php echo $suffix; ?> .personposition {
						font-style: italic;
					}
				
					.trombinoscope_<?php echo $suffix; ?> .persontel {
						
					}
					
					.trombinoscope_<?php echo $suffix; ?> .personmobile {
						background: transparent url(images/con_mobile.png) 0 0 no-repeat;
						padding-left: 20px;
						display: inline-block;
					}
					
					.trombinoscope_<?php echo $suffix; ?> .personfax {
						background: transparent url(images/con_fax.png) 0 0 no-repeat;
						padding-left: 20px;
						display: inline-block;
					}
					
					.trombinoscope_<?php echo $suffix; ?> .personemail {
						background: transparent url(images/con_email.png) 0 0 no-repeat;
						padding-left: 20px;
						display: inline-block;
					}

					.trombinoscope_<?php echo $suffix; ?> .personemail span {
						/*display: none;*/
					}
					
					.trombinoscope_<?php echo $suffix; ?> .personwebpage {
						background: transparent url(images/con_weblink.png) 0 0 no-repeat;
						padding-left: 20px;	
						display: inline-block;		
					}
					
					.trombinoscope_<?php echo $suffix; ?> .personwebpage span {
						/*display: none;*/
					}
					
					.trombinoscope_<?php echo $suffix; ?> .personaddress {
						background: transparent url(images/con_home.png) 0 0 no-repeat;
						padding-left: 20px;display:none;
					}
					
					.trombinoscope_<?php echo $suffix; ?> .personsuburb {}
					
					.trombinoscope_<?php echo $suffix; ?> .personstate {}
					
					.trombinoscope_<?php echo $suffix; ?> .personformattedaddress {}
					
					.trombinoscope_<?php echo $suffix; ?> .personcountry {}
					
					.trombinoscope_<?php echo $suffix; ?> .personmiscinfo {}
					
					.trombinoscope_<?php echo $suffix; ?> .personposition_empty {} /*        => styles if the fields are empty of data */
				
					.trombinoscope_<?php echo $suffix; ?> .persontel_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personmobile_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personfax_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personemail_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personwebpage_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personaddress_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personsuburb_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personstate_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personformattedaddress_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personcountry_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> .personmiscinfo_empty {}
					
					.trombinoscope_<?php echo $suffix; ?> ._empty {}
				
				.trombinoscope_<?php echo $suffix; ?> .personlink { /*                       => link to the contact */               
					margin-top: 10px;
					font-size: 0.9em;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personlink a {
					background: transparent url(images/contact_info.png) 0 0 no-repeat;
					padding-left: 20px;
					display: inline-block;
				}
				
				.trombinoscope_<?php echo $suffix; ?> .personlink a span {
					/* display: none; */
				}
